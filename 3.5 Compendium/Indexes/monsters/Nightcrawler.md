---
lang: en
title: 3.5 Compendium / Monsters / Nightcrawler
aliases: 
 - Nightcrawler
tags: 
 - 3.5e
...
### Energy Drain (Su)
Living creatures inside a nightcrawler's gizzard gain one negative level each round. The DC is 26 for the Fortitude save to remove a negative level. The save DC is Charisma-based. For each such negative level bestowed, the nightcrawler gains 5 temporary hit points.
...
### Summon Undead (Su)
A nightcrawler can summon undead creatures once per night
