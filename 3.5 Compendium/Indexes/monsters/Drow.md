---
lang: en
title: 3.5 Compendium / Monsters / Drow
aliases: 
 - Drow
tags: 
 - 3.5e
...
### Favored Class
Wizard (male) or cleric (female). This trait replaces the high elf 's favored class.

### The drow warrior presented here had the following ability scores before racial adjustments
Str 13, Dex 11, Con 12, Int 10, Wis 9, Cha 8.
...
-  Drow can use the following spell-like abilities once per day: [[Spell List#Dancing Lights|Dancing Lights]] , [[Spell List#Darkness|Darkness]] , [[Spell List#Faerie Fire|Faerie Fire]] ; . Caster level equals the drow's class levels.;
