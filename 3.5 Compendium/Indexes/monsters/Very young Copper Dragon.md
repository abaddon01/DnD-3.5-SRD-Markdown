---
lang: en
title: 3.5 Compendium / Monsters / Very_young_Copper_Dragon
aliases: 
...
tags: 
 ...
 - rules
 - monsters
 - Very_young_Copper_Dragon
 - CR5
type: Copper Dragon(Very young)
cr: 5
environment: 
alignment: 
---
...
| Attack:              |+10; |
| Full Attack:         |Bite  +8 (1d6), 2 Claws +6/+6 (1d6/1d6); |
...
### Breath Weapon (Su)
A copper dragon has two types of breath weapon, a line of acid and a cone of slow gas. Creatures within the cone must succeed on a Fortitude save or be slowed for 1d6 rounds plus 1 round per age category of the dragon. Line: 40 ft. Damage: 4d4 (DC 15). 
