...
| ! | Human Form Werewolf Lord - Medium (Humanoid [Human, Shapechanger, Werewolf]) | 
| ----| ---- | 
...
| Attack:              |+2 bastard sword +21 melee (1d10+8/17-20) or masterwork composite longbow (+4 Str bonus) (2d8+15/17-20) +17 ranged (1d8+4/x3); |
| Full Attack:         |+2 bastard sword +21/+16/+11 melee (1d10+8/17-20) or masterwork composite longbow (+4 Str bonus) +17/+12/+7ranged (1d8+4/x3); |
...
| Skills:              |[[Skill List#null\|null\]\]: +4, [[Skill List#null\|null\]\]: +6, [[Skill List#null\|null\]\]: +9, [[Skill List#null\|null\]\]: +8, [[Skill List#null\|null\]\]: +13, [[Skill List#null\|null\]\]: +5; |
...
#### Trip (Ex)
A werewolf in animal form that hits with a bite attack can attempt to trip the opponent (+2 check modifier) as a free action without making a touch attack or provoking an attack of opportunity. If the attempt fails, the opponent cannot react to trip the werewolf.
...
#### The werewolf presented here is based on a 1st-level human warrior and natural lycanthrope, using the following base ability scores
